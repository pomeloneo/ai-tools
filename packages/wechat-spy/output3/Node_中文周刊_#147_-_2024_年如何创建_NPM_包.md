...
https://syntax.fm/show/811/nodejs-evolves?utm\_medium=paid-community&utm\_source=nodeweekly&utm\_campaign=fy25q3-syntax&utm\_content=syntax-listen
...
-   Deno 项目还在 X 上宣布其 Deno 标准库现已被视为稳定版。标准库是一套包，提供了从数据结构到加密再到时间管理的各种功能，其中许多可以在多个 JS 运行时（包括 Node）中使用。
    ...
    **长按识别二维码查看原文**   
    ...
    https://x.com/deno\_land/status/1826406094287368293
