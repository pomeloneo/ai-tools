# JavaScript 中文周刊 #80 - 加快 JavaScript 生态系统的发展

> 原文链接: http://mp.weixin.qq.com/s?__biz=MzIzOTkwMjM0OQ==&mid=2247518364&idx=1&sn=61f2653793a316a09f7fef5df1ff15df&chksm=e921c37ede564a68ccc833cc5c4df149c0e10e96a1267ea34be62f3e48777e5928114e648267#rd
...
> _‘npm scripts’是 JavaScript 开发者经常执行的命令，但它们并没有被特别优化，每次执行都会增加大约 400 毫秒的开销。在这篇文章中，我们能够将这个开销降低到约 22 毫秒。”_
...
**Playwright v1.32 – 现在有了 UI 模式** — 这个流行的 Web 测试和自动化框架正在向 Cypress 这样的工具所服务的领域迈进，它提供了一个 “UI 模式”，让你可以在一个 UI 环境中探索、运行和调试测试，还有观察模式。这里有一个 **介****绍视频****。**
...
-   _The New Stack_ 采访了 Svelte 的 Rich Harris **关于 SvelteKit 和 Svelte 4 即将推出的内容**。
...
-   🥇 祝贺 Lea Verou **被任命为 TC39 委员会成员**。她推动互联网向前发展的努力是具有传奇色彩的。Prism 是你可能知道的一个项目。
    ...
    **长按识别二维码查看原文**   
    ...
    https://twitter.com/LeaVerou/status/1639043004190031876  
...
**前端“已死”？** — 最近有一种说法认为，像 GPT-4 这样的大型语言模型（甚至像 **Copilot X** 这样的工具）可能很快就会让一些开发者失业——然而，Josh 对“_这些人工智能进步对软件开发未来的意义充满乐观_”。
...
**想要****从 Angular 切换到** **Signals 之前，你一****定要先做这件事！**
...
**DOCX v8.0：用 JavaScript 生成 Word \`.docx\` 文件** — 布局文档的代码很冗长，但功能很多。这里有一个 **CodePen 示****例** 和 **发布说明** – **仓库地址****。**
