# JavaScript 中文周刊 #8 - 震惊，npm 存储库于 10 月 7 日发生了停电事件！

> 原文链接: http://mp.weixin.qq.com/s?__biz=MzIzOTkwMjM0OQ==&mid=2247493760&idx=1&sn=23228ff65f8d96544f2e5e7d589282ad&chksm=e921a362de562a74251feace44330ea95a55622fd168bbeac7d660fb7740bd6a11d870d77c1c#rd
> 抓取时间: 2026/2/2 23:53:49

---

> 本期看点：npm 存储库于 10 月 7 日发生了停电事件，随即官方也发布了消息解释。不清楚屏幕前的你当时有没有感知到！另外 2021 年的 CSS 现状调查也已经启动，VSCode 也发布了新版本。

> 编辑：Matrixbirds、liu-jin-yi、QC-L
...
**kill-port：清除运行在指定端口上的进程** — 例如，你可以使用命令 `npx kill-port 3000` 去关闭监听在 3000 端口的程序，对于 Unix 和 macOS 系统，它基本上是在后台运行 `lsof` 和 `kill` , 并且支持 Windows 系统。
...
**fast-pn****g：完全用 JavaScript 实现的 png 解码器和编码器****。**
