# JavaScript 中文周刊 #135 - Quill v2.0 发布：强大的 Web 富文本编辑器

> 原文链接: http://mp.weixin.qq.com/s?__biz=MzIzOTkwMjM0OQ==&mid=2247531144&idx=1&sn=26dbf18a75bb77d3a87433dc6d81d0c8&chksm=e921316ade56b87c66d4b040da08a44d323ecf20a7f57f4f551dfaa9aaddaec143b4dedf8395#rd
...
**Quill v2.0：强大的 Web 富文本编辑器** —— 这是一个开源的所见即所得编辑器的重大发布。在 Quill v2.0 发布 这篇文章中，我们了解到 Quill 完全使用 TypeScript 进行重写和对现代浏览器功能的改进使用，但是还有更多正在开发中 的功能，比如它的 ESM 打包。想要尝试一下吗？这里有一个在线体验。
...
-   📺 Bartek Szwej 整理了一份过去一年的 300 个 JavaScript 相关视频的列表，按照他们的 YouTube 观看次数排序。
    ...
    **长按识别二维码查看原文**   
    ...
    https://techtalksweekly.substack.com/p/ttw-extra-3-all-javascript-conference
...
https://www.mux.com/blog/keeping-up-with-the-node-ish-ecosystem
...
https://github.com/pubkey/rxdb/releases/tag/15.18.0
...
https://github.com/emberjs/ember.js/releases/tag/v5.8.0
