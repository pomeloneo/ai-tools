# JavaScript 中文周刊 #36 - 关于 Web Component 的 7 个技巧！

> 原文链接: http://mp.weixin.qq.com/s?__biz=MzIzOTkwMjM0OQ==&mid=2247505277&idx=1&sn=10451458687ef549318cfad62613cb33&chksm=e9219e9fde561789bfc2e50ba97a28bbd623a676851c12208a03a0173b6e68a69f1951e51946#rd
> 抓取时间: 2026/2/2 23:53:15

---

> 本期看点：本期为大家带来了Emberjs 在 Typescript 领域的尝试与关于 Web Component 的 7 个技巧等优秀文章。点击本期周刊查看更多精彩文章！

> 编辑：Yucohny、Matrixbirds

## 🔥 本周热门

**Lexical：可扩展的文本编辑器库** — Lexical 是由 Meta 团队创作的新的文本编辑器框架，其设计理念为易于访问、高性能和可靠性。压缩后的大小仅有 22KB，同时支持 React 18，后续也会发布 iOS 版本。
...
**OpenJS 基金会发布 \_JavaScriptLandia\_ 奖项问卷**— 早在 2020 年，OpenJS 基金会就推出了 **JavaScriptLandia** 奖项，作为表达对 JS 生态系统支持的一种方式。现在，OpenJS 基金会发布问卷，大家可以提名 JS 生态系统中的任何人，以表彰他们所做的辛勤工作。所以，快找到你最喜欢的新库并提名它的创建者吧！

**长按识别二维码查看原文**   

https://docs.google.com/forms/d/e/1FAIpQLSdjnMJaHuOX3bz0-1-GMILNGMSIuHfFG6jEQWVs3LK7fGGStA/viewform
...
-   尽管 **Carbon** 在格式化推文、图像等一直占据一席之位，但现在，**Chalkist** 将是要考虑的另一个选项。
...
**fast-json-s****tringify v3.1.0** – 更快的 `JSON.stringify()`。  
...
https://jackchilds.tech/posts/reducing\_spam\_from\_mailto\_links
...
**Terminal W****ordle: 使用 React Ink 编写一个终端版本的 Wordle 游戏**
...
https://handsontable.com/blog/articles/2022/4/whats-new-in-hyperformula-2.0.0
