# JavaScript 中文周刊 #129 - Eloquent JavaScript 第四版发布

> 原文链接: http://mp.weixin.qq.com/s?__biz=MzIzOTkwMjM0OQ==&mid=2247529484&idx=1&sn=ad9a691034ff713650bd980af18db154&chksm=e9213feede56b6f834de88b8b75d57127d519d78825bc69eb475ec47b46e7700fc52c3a83eb6#rd
...
-   如果这个世界是 JavaScript 编写的？好像也没那么糟糕。
...
-   客户端安全不再重要？还是越来越重要？ Gal Weizman 提出了这个问题。
    ...
    **长按识别二维码查看原文**   
    ...
    https://weizmangal.com/2024/02/10/client-side-future/
...
https://pqina.nl/blog/web-bluetooth-api-read-bbq-temperature-sensor-data/
...
**ONBOARDING\_LIB：一个无头引导库** —— 这是一个用于在 React 应用程序中构建可访问、可定制和持久化引导流程的引导库。该网站本身就是这种流程的一个示例。
...
-   **Node.js v21.7（Current）** – Node.js 新增了内置的彩色文本输出，可以加载和解析环境变量，并支持在 `.env` 文件中使用多行数值。
    
-   **TypeScript v5.4** – 改进了类型收窄，引入了 `NoInfer` 实用类型，以及 `Object.groupBy` 与 `Map.groupBy` 等新特性。
    
-   **Mermaid v10.9** – 从文本生成图表的工具。
    
-   **Bun v1.0.30**
    
-   **Vue Language Tools v2.0**
